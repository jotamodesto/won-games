...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/jotamodesto/won-games',
  },
  {
    name: 'Twitter',
    link: 'https://twitter.com/jotasm',
  },
  {
    name: 'Careers',
    link: 'https://www.linkedin.com/in/johnatanmodesto',
  },
];
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>
                Ao lado você pode inserir diferentes jogos categorias e publishers para as nossas maravilhosas categorias e publishers
              </P>
